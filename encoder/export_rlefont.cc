...
namespace mcufont
{
    namespace rlefont
    {
        ...
        void write_source(std::ostream &out, std::string name, const DataFile &datafile)
        {
            ...
            out << "    {" << std::endl;
            out << "    "
                << "\"" << datafile.GetFontInfo().name << "\"," << std::endl;
            out << "    "
                << "\"" << name << "\"," << std::endl;
            ...
            out << "    "
                << "&mf_rlefont_character_width," << std::endl;
            out << "    "
                << "&mf_rlefont_render_character," << std::endl;
            out << "    }," << std::endl;

            out << "    " << RLEFONT_FORMAT_VERSION << ", /* version */" << std::endl;
            out << "    "
                << "mf_rlefont_" << name << "_dictionary_data," << std::endl;
            out << "    "
                << "mf_rlefont_" << name << "_dictionary_offsets," << std::endl;
            ...
            out << "    "
                << "mf_rlefont_" << name << "_char_ranges," << std::endl;
            out << "};" << std::endl;
