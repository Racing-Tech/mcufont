    ...
    namespace bwfont
    {
        ...
        void write_source(std::ostream &out, std::string name, const DataFile &datafile)
        {
            ...
            for (size_t i = 0; i < ranges.size(); i++)
            {
                ...
                out << "        "
                    << "mf_bwfont_" << name << "_glyph_data_" << i << ", /* glyph data */" << std::endl;
                out << "    }," << std::endl;
            }
            out << "};" << std::endl;
            out << std::endl;
            ...
            out << "    "
                << "&mf_bwfont_character_width," << std::endl;
            out << "    "
                << "&mf_bwfont_render_character," << std::endl;
            out << "    }," << std::endl;

            out << "    " << BWFONT_FORMAT_VERSION << ", /* version */" << std::endl;
            out << "    " << ranges.size() << ", /* char range count */" << std::endl;
            out << "    "
                << "mf_bwfont_" << name << "_char_ranges," << std::endl;
            out << "};" << std::endl;
